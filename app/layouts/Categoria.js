export const Categoria = () => {
  const _categoriaHtml = `<div class="page-content">
      ...
      <div class="col-sm">
        <a href="/categoria" class="collection-grid-3-item image-hover-scale">
          <div class="collection-grid-3-item-img image-container" style="padding-bottom: 68.22%">
            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="https://storage.googleapis.com/work-resources/images/skins/fashion/banner-category-01.png" class="lazyload fade-up" alt="Banner">
            <div class="foxic-loader"></div>
          </div>
          <div class="collection-grid-3-caption-bg">
            <h3 class="collection-grid-3-title">Parte Superior</h3>
            <h4 class="collection-grid-3-subtitle">El&nbsp;Mejor&nbsp;Look&nbsp</h4>
          </div>
        </a>
      </div>
      <div class="col-sm">
        <a href="/categoria" class="collection-grid-3-item image-hover-scale">
          <div class="collection-grid-3-item-img image-container" style="padding-bottom: 68.22%">
            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/banner-category-02.png" class="lazyload fade-up" alt="Banner">
            <div class="foxic-loader"></div>
          </div>
          <div class="collection-grid-3-caption-bg">
            <h3 class="collection-grid-3-title">Parte inferior</h3>
            <h4 class="collection-grid-3-subtitle">Vive&nbsp;por&nbsp;la&nbsp;Moda</h4>
          </div>
        </a>
      </div>
    </div>
...
<div class="filter-row">
  <div class="row">
    <div class="items-count">35 producto(s)</div>
    ...
    <div class="viewmode-wrap d-none">
      <div class="view-mode">
...
<!-- /Filter Row -->
    ...
    <div class="sidebar-block_content">
      <div class="selected-filters-wrap">
        ...
        <div class="d-flex flex-wrap align-items-center">
          <a href="#" class="clear-filters"><span>Limpiar filtros</span></a>
          <div class="selected-filters-count ml-auto d-none d-lg-block">Filtros: <span>6 ítems</span></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="sidebar-block filter-group-block open">
    ...
    <div class="sidebar-block_content">
      <ul class="category-list">
        <li class="active"><a href="/categoria" title="Casual" class="open">Casual <span>(30)</span></a>
          <div class="toggle-category js-toggle-category"><span><i class="icon-angle-down"></i></span></div>
          <ul class="category-list category-list">
            <li><a href="/categoria" title="Men">Hombre <span>(10)</span></a></li>
            <li><a href="/categoria" title="Women">Mujer <span>(10)</span></a></li>
            <li><a href="/categoria" title="Accessories">Accesorios <span>(10)</span></a></li>
          </ul>
        </li>
        <li><a href="/categoria" title="T-Shirts" class="open">Polos </a></li>
        <li><a href="/categoria" title="Medical" class="open">Médico </a></li>
        <li><a href="/categoria" title="FoodMarket" class="open">Alimentos </a></li>
        <li><a href="/categoria" title="Bikes" class="open">Bicicletas <span>(12)</span></a></li>
        <li><a href="/categoria" title="Cosmetics" class="open">Cosmeticos <span>(16)</span></a></li>
        <li><a href="/categoria" title="Fishing" class="open">Pesca <span>(20)</span></a></li>
        <li><a href="/categoria" title="Electronics" class="open">Electrónica <span>(15)</span></a></li>
        <li><a href="/categoria" title="Games" class="open">Juegos <span>(14)</span></a></li>
      </ul>
    </div>
  </div>
  ...
  <a href="https://bit.ly/3eJX5XE" class="bnr image-hover-scale bnr--bottom bnr--left" data-fontratio="3.95">
    <div class="bnr-img">
      <img src="https://storage.googleapis.com/work-resources/images/banners/banner-collection-aside.png" alt="">
    </div>
  </a>
</div>
      </div>
      ...
      <div class="filter-toggle js-filter-toggle">
        ...
        <span class="filter-toggle-text"><a href="#" class="filter-btn-open js-filter-btn">ORDENAR</a><a href="#" class="filter-btn-close js-filter-btn">LIMPIAR</a><a href="#" class="filter-btn-apply js-filter-btn">APLICAR Y CERRAR</a></span>
      </div>
      <!-- /Left column -->
      <!-- Center column -->
...
<div class="prd-grid product-listing data-to-show-3 data-to-show-md-3 data-to-show-sm-2 js-category-grid" data-grid-tab-content>
  ...
  <div class="prd-inside">
    <div class="prd-img-area">
      <a href="/producto" class="prd-img image-hover-scale image-container">
        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-01-1.jpg" alt="Leather Pegged Pants" class="js-prd-img lazyload fade-up">
        <div class="foxic-loader"></div>
      ...
      <div class="prd-circle-labels">
        ...
        <a href="#" class="circle-label-qview js-prd-quickview prd-hide-mobile" data-src="ajax/ajax-quickview.html"><i class="icon-eye"></i><span>Vista Rápida</span></a>
        ...
        <div class="colorswatch-label colorswatch-label--variants js-prd-colorswatch">
          ...
          <ul>
            <li data-image="images/skins/fashion/products/product-01-1.jpg"><a class="js-color-toggle" data-toggle="tooltip" data-placement="left" title="Color Name"><img src="https://storage.googleapis.com/work-resources/images/colorswatch/color-orange.png" alt=""></a></li>
            <li data-image="images/skins/fashion/products/product-01-color-2.jpg"><a class="js-color-toggle" data-toggle="tooltip" data-placement="left" title="Color Name"><img src="https://storage.googleapis.com/work-resources/images/colorswatch/color-black.png" alt=""></a></li>
            <li data-image="images/skins/fashion/products/product-01-color-3.jpg"><a class="js-color-toggle" data-toggle="tooltip" data-placement="left" title="Color Name"><img src="https://storage.googleapis.com/work-resources/images/colorswatch/color-red.png" alt=""></a></li>
          </ul>
        </div>
      ...
      <ul class="list-options color-swatch">
        <li data-image="images/skins/fashion/products/product-01-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-01-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
        
        <li data-image="images/skins/fashion/products/product-01-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-01-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
        
        
        <li data-image="images/skins/fashion/products/product-01-3.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-01-3.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
...
</div><div class="prd prd--style2 prd-labels--max prd-labels-shadow prd-outstock">
  <div class="prd-inside">
    <div class="prd-img-area">
      <a href="product.html" class="prd-img image-hover-scale image-container">
