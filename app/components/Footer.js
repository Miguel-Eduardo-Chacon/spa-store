export const Footer = () => {
  const _footerHtml = `<footer class="page-footer footer-style-6 ">
  <div class="holder ">
      ...
      <div class="container">
        <div class="text-icn-blocks-bg-row">
          <div class="text-icn-block-footer">
            ...
            <div class="text">
              <h4>Envíos super rápidos</h4>
              <p>Tu orden será enviada entre 3-5 días hábiles después de que tus productos se encuentren disponibles</p>
            </div>
          </div>
          <div class="text-icn-block-footer">
            <div class="icn">
            ...
            <div class="text">
              ...
              <p>Actualizamos nuestros precios de acorde al mercado actual de manera inmediata</p>
            </div>
          </div>
          <div class="text-icn-block-footer">
            <div class="icn">
            ...
            <div class="text">
              <h4>Garantía</h4>
              <p>Si el producto que requieres está disponible, podemos procesar su devolución y generar una nueva orden</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-0">
          ...
          <div class="footer-block">
            <div class="footer-logo">
              <a href="index.html"><img class="lazyload fade-up"
                  ...
                  data-srcset="https://storage.googleapis.com/work-resources/images/logo-footer.png 1x, https://storage.googleapis.com/work-resources/images/logo-footer2x.png 2x"
                  alt="Logo"></a>
            </div>
            <div class="collapsed-content">
              <ul>
                <li>E-mail: <a href="mailto:Foxshop@gmail.com">Foxshop@gmail.com</a></li>
                <li>Horario: 10:00 - 18:00, Lun - Vie</li>
              </ul>
            </div>
            ...
            <div class="d-lg-none mt-3">
              <div class="box-coupon">
                ...
                <div class="box-coupon-text"><span class="custom-color">MAIK</span> DEV</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="footer-block collapsed-mobile">
            ...
            <div class="collapsed-content">
              <ul>
                ...
                <li><a href="typography.html">Política de devoluciones</a></li>
                <li><a href="typography.html">Costos de envío</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-lg col-xl">
          <div class="footer-block collapsed-mobile">
            ...
            <div class="collapsed-content">
              <ul>
                <li><a href="account-details.html">Mi cuenta</a></li>
                <li><a href="cart.html">Ver carrito</a></li>
                <li><a href="account-wishlist.html">Mi lista de deseados</a></li>
                <li><a href="account-history.html">Estado de la orden</a></li>
                <li><a href="account-history.html">Rastrear mi orden</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-auto sticky-addcart_image">
          <a href="product.html">
            <img src="https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-01-1.jpg" alt="" />
          </a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-auto popup-addedtocart_logo">
          <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
            data-src="https://storage.googleapis.com/work-resources/images/logo-white-sm.png" class="lazyload fade-up" alt="">
        </div>
...
<div class="footer-sticky">
  <div class="payment-notification-wrap js-pn" data-visible-time="3000" data-hidden-time="3000" data-delay="500"
    ...
    data-products='[{"productname":"Leather Pegged Pants", "productlink":"product.html","productimage":"https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-01-1.jpg"},{"productname":"Black Fabric Backpack", "productlink":"product.html","productimage":"https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-28-1.jpg"},{"productname":"Combined Chunky Sneakers", "productlink":"product.html","productimage":"https://storage.googleapis.com/work-resources/images/skins/fashion/products/product-23-1.jpg"}]'>
    <div class="payment-notification payment-notification--squared">
      <div class="payment-notification-inside">
        <div class="payment-notification-container">
          <a href="#" class="payment-notification-image js-pn-link">
            <img src="https://storage.googleapis.com/work-resources/images/products/product-01.jpg" class="js-pn-image" alt="">
          </a>
